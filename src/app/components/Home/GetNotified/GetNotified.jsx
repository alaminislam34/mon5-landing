    ...
    <section id="launch">
      <div className="max-w-380 mx-auto w-11/12 py-12 md:py-16">
        <SectionTitle
          ...
          colorTitle={content.sectionTitleAccent}
          left="left"
        />
        <div className="flex items-center relative">
          ...
          >
            <Image
              ...
              priority={false}
              className="relative z-0 scale-125 left-24 md:left-10 md:scale-155 lg:bottom-30 bottom-20 object-contain pointer-events-none"
            />
          </motion.div>
        </div>
      </div>
