...
function Banner() {
  ...
  return (
    <section className="relative">
      <div className="max-w-380 mx-auto min-h-120 md:min-h-130 lg:min-h-180 xl:min-h-150 flex items-center bg-cover bg-center relative z-10">
        <motion.div
